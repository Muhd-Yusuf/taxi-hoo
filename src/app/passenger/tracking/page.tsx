    ...
    <>
      ...
      <div className="bg-zinc-50 rounded-xl px-4 py-3 mb-4">
        <p className="text-sm text-zinc-700">
          ...
          <span className="font-semibold text-brand-600">3:35</span>
        </p>
      </div>

      {/* Driver info with colored border */}
      <div className="border border-brand-100 rounded-2xl p-0.5 bg-gradient-to-r from-brand-50/50 to-transparent">
      ...
      <div className="mt-4 pt-4 border-t border-zinc-100">
        <div className="flex items-start gap-3">
          <div className="flex flex-col items-center gap-1 pt-1">
            ...
            <div className="w-px h-8 bg-gradient-to-b from-brand-300 to-blue-300" />
            <div className="w-2.5 h-2.5 rounded-sm bg-blue-500 shadow-sm shadow-blue-500/50" />
          </div>
          <div className="flex-1 space-y-4">
            <div>
              <p className="text-xs text-brand-500 font-medium">Pickup</p>
      ...
      <div className="grid grid-cols-3 gap-3 mt-4">
        ...
        <div className="bg-brand-50 border border-brand-100 rounded-xl p-3 text-center">
          <PiCurrencyDollarFill size={14} className="text-brand-500 mx-auto mb-1" />
          <p className="text-sm font-bold text-brand-700">P3,500</p>
          <p className="text-[10px] text-brand-400 font-medium">Fare</p>
        </div>
      </div>
      ...
      <div className="flex gap-3 mt-4">
        ...
        <button className="flex-1 h-12 bg-brand-500 rounded-xl text-sm font-semibold text-white flex items-center justify-center gap-2">
  ...
  return (
    <div className="h-full relative flex flex-col lg:flex-row">
      ...
      <div className="relative flex-1 h-full">
        ...
        {/* Gradient overlay at top (mobile only) */}
        <div className="absolute top-0 left-0 right-0 h-28 bg-gradient-to-b from-zinc-900/50 via-zinc-900/20 to-transparent z-10 pointer-events-none lg:hidden" />

        {/* Top overlay - Status bar (mobile only) */}
        <div className="absolute top-4 left-4 right-4 z-20 lg:hidden">
          <RideStatusBar status="arriving" driverName="Thabo Mokobi" eta="3 min" />
        </div>

        {/* Bottom sheet - always visible (mobile only) */}
