    ...
    <div className="min-h-full bg-white pb-6">
      ...
      <div className="flex justify-center pt-6">
        <div className="relative">
          <div className="w-24 h-24 rounded-full bg-zinc-900 text-emerald-400 flex items-center justify-center text-2xl font-bold">
            JO
          </div>
      ...
      <div className="px-5 mt-8">
        ...
        {/* Logout */}
        <button className="w-full h-14 bg-emerald-500 text-white font-semibold rounded-2xl text-sm mt-8 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform">
